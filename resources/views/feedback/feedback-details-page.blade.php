            ...
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <h4 class="text-end">Details Feedback Page</h4>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-10 py-2 px-2">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="text" class="form-control" placeholder="Ex, Feedback Title" name="feedbackTitle" value="{{ $selectEmployee->feedback_title }}" disabled >
                            </div>
                        </div>
                        {{--  --}}
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <select name="feedback_category" id="feedback_category" class="form-control" disabled >
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                <label class="text-end mx-2 mt-1" for="" style="width:300px;">Feedback Category:</label>
                                <select name="feedback_category" id="feedback_category" class="form-control" disabled >
                                    <option value="">{{ $selectEmployee->name }}</option>
                                </select>
                            </div>
                        </div>
                        {{--  --}}
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-start py-2">
                                ...
                                <textarea name="feedback_details" rows="5" cols="30" class="form-control" disabled >{{ $selectEmployee->feedback_details }}</textarea>
                            </div>
                        </div>
                        {{--  --}}
                        </div>
