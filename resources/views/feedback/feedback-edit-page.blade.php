...
<head>
    ...
    <title>Feedback Edit Page</title>
</head>
<body>
       ...
       <div class="alert alert-danger alert-dismissible fade show px-4 d-flex justify-content-center flex-column" role="alert">
        ...
        <div class="card">
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <h4 class="text-end">Edit Feedback Page</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                @endforeach
                <form action="{{ route('editFeedbackOperation',$selectEmployee->id) }}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="col-10 py-2 px-2">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="text" class="form-control" placeholder="Ex, Feedback Title" name="feedbackTitle" value="{{ $selectEmployee->feedback_title }}">
                            </div>
                        </div>
                        {{--  --}}
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                <label class="text-end mx-2 mt-1" for="" style="width:300px;">Feedback Title:</label>
                                <input type="email" class="form-control" placeholder="Ex, abc@abc.com" name="feedbackEmail" value="{{ $selectEmployee->feedback_email }}">
                            </div>
                        </div>
                        {{--  --}}
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <select name="feedback_category" id="feedback_category" class="form-control">
                                    <option value="">{{ $selectEmployee->category_name }}</option>
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-start py-2">
                                ...
                                <textarea name="feedback_details" rows="5" cols="30" class="form-control">{{ $selectEmployee->feedback_details }}</textarea>
                            </div>
                        </div>
                        {{--  --}}
                        </div>
