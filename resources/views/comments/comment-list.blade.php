            ...
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <h4 class="text-end">Comments List</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    <input type="text" class="form-control" id="searchComments"  name="searchComments">
                <div class="col-12 py-2">
                    ...
                    <table class="table">
                        ...
                        @if ( $commentsSelect->isEmpty() )
                            
                        @else
                        <tbody id="clientData">
                            <div id="total_records">
                            @foreach ($commentsSelect as $commentsSelects)
                            <tr>
                                <th scope="row" style="width: 10%;text-align:center">
                                    {{ $commentsSelects->id }}
                                </th>
                                <td  style="width: 20%;text-align:center">
                                    {{ $commentsSelects->name }}
                                </td>
                                <td  style="width: 10%;text-align:center">
                                    {{ $commentsSelects->created_at }}
                                </td>
                                <td  style="width: 40%;text-align:center">
                                    {{ $commentsSelects->comments }}
                                </td>
                                <td  style="width: 20%;text-align:center">
                                    <a href="" class="mx-1 text-decoration-none  btn btn-outline-danger "><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            </div>
                    ...
                    {{-- {{ $selectCategory->links('pagination::bootstrap-5') }} --}}
                </div>
            </div>
        </div>
    </div>
