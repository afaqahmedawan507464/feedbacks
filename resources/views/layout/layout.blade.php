        ...
        <nav class="navbar navbar-light navbar-vertical navbar-expand-xl">
          ...
          <div class="d-flex align-items-center">
            <div class="toggle-icon-wrapper">
              ...
              <div class="d-flex align-items-center py-3"><span class="font-sans-serif">Tasks</span>
              </div>
            </a>
          </div>
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                    <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard2" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dashboard2">
                      <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-project-diagram"></span></span><span class="nav-link-text ps-1">Catagory</span>
                      </div>
                    </a>
                    <ul class="nav collapse show" id="dashboard2">
                      <li class="nav-item"><a class="nav-link" href="{{ route('categoryListPage') }}" aria-expanded="false">
                          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Catagory List</span>
                          </div>
                        </a>
                        <!-- more inner pages-->
                      </li>
                ...
                <li class="nav-item">
                  <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard2" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dashboard2">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-comments"></span></span><span class="nav-link-text ps-1">Feedback List</span>
                    </div>
                  </a>
                  <ul class="nav collapse show" id="dashboard2">
                    <li class="nav-item"><a class="nav-link" href="{{ route('feedbackListPage') }}" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Feedback List</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
        ...
        <div class="content">
          <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="index.html">
              <div class="d-flex align-items-center"><span class="font-sans-serif">Task</span>
              </div>
            </a>
            <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
              ...
              <li class="nav-item dropdown"><a class="nav-link pe-0" id="navbarDropdownUser" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <p class="mt-3">{{ Auth::guard('user')->user()->name }}</p>
                </a>
                <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                  <div class="bg-white dark__bg-1000 rounded-2 py-2">
                    {{-- <a class="dropdown-item" href="pages/user/profile.html">Profile &amp; account</a> --}}
                    {{-- <a class="dropdown-item" href="{{ route('feedbackMyListPage') }}">Feedback</a> --}}
          ...
          <footer class="footer">
            <div class="row g-0 justify-content-between fs--1 mt-4 mb-3">
              {{-- <div class="col-12 col-sm-auto text-center">
                <p class="mb-0 text-600">Thank you for creating with AFaq <span class="d-none d-sm-inline-block">| </span><br class="d-sm-none" /> 2024 &copy; Task</p>
              </div>
              <div class="col-12 col-sm-auto text-center">
                <p class="mb-0 text-600">v0.0.0.1</p>
              </div> --}}
            </div>
          </footer>
        </div>
